 ...
 * @author akhrain
 */
public class MinInstruction extends Instruction
{
    private CodeString array_ = null;
    private CodeString variable_ = null;
    
    public MinInstruction(String var, String arr,CodeSheet cs) 
    {
    ...
    public void execute(CodeSheet cs, ExecutionMacro em) 
    {
        ...
        if(arr == null)
        {
            cs.printError("\nFILE: "+
                ...
                "\nERROR: Problem with fuction 'min' in line "+
                this.getLine()+
