 ...
 * @author akhrain
 */
public class MinPosInstruction extends Instruction
{
    private CodeString array_ = null;
    private CodeString variable_ = null;
    
    public MinPosInstruction(String var, String arr,CodeSheet cs) 
    {
    ...
    public void execute(CodeSheet cs, ExecutionMacro em) 
    {
        ...
        if(arr == null)
        {
            cs.printError("\nFILE: "+
                ...
                "\nERROR: Problem with fuction 'min-pos' in line "+
                this.getLine()+
