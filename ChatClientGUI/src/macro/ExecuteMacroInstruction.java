 ...
 * @author akhrain
 */
public class ExecuteMacroInstruction extends Instruction
{
    private CodeString macroName_ = null;
    private MacroCode  input     = null;
    
    public ExecuteMacroInstruction(String name, MacroCode in,CodeSheet cs) 
    {
    ...
    public void execute(CodeSheet cs, ExecutionMacro em) 
    {
        ...
        cs.executeMacroByName(macroName,em,input);
    }
}
